...
#define HUMAN_ONLY_JOBS /datum/job/captain, /datum/job/hop, /datum/job/cmo, /datum/job/chief_engineer, /datum/job/hos, /datum/job/pathfinder, /datum/job/rd
...
#undef HUMAN_ONLY_JOBS
	...
	allowed_jobs = list(/datum/job/captain, /datum/job/hop, /datum/job/rd, /datum/job/cmo, /datum/job/chief_engineer, /datum/job/hos,
						...
						/datum/job/doctor, /datum/job/chemist, /datum/job/medical_trainee,
						/datum/job/chaplain,
